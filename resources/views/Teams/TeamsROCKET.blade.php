...
<div style="height: 480px; overflow: hidden;">
    <img src="/Images/rocket fondo.webp" style="width: 100%; height: 130%; object-fit: cover;" alt="">
</div>
<H1><p class="letrabonita">ROCKET LEAGUE</p></H1>

    <div class="row mb-0">
        <div class="image-div">
            <img src="/Images/PLAYER de rocket.webp" style=" width: 100%; height: 100%;" alt="Imagen 1">
            <div class="image-text1 ">
                <p class="jersey-name mb-0">Noly</p>
            </div>
        </div>
        ...
        <div class="image-div">
            ...
            width: 100%; "  alt="Imagen 2">
             <div class="image-text2">
                <p class="jersey-name mb-0">Chronic</p>
        ...
        <div class="image-div">
            ...
            width: 100%; "  alt="Imagen 3">
             <div class="image-text3">
                <p class="jersey-name mb-0">Apparentlyjack</p>
        ...
        <div class="image-div">
            ...
            width: 100%; "  alt="Imagen 4">
             <div class="image-text4">
                <p class="jersey-name mb-0">Pollo</p>
    ...
    <div class="row mt-0">
        <div class="image-div">
            ...
            width: 100%; "  alt="Imagen 5">
             <div class="allushin">
                <p class="jersey-name mb-0">Allushin</p>
                <p class="jersey-price">Coach</p>
            </div>
        </div>
